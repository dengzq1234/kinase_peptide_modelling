...
def makefile(all_files):
    columns = ['peptide_model','peptide_name','Atom1', 'Atom2','Clash','Covalent','VdW_Clash','VdW','Proximal','Hydrogenbond',
    ...
    for filename in all_files: #filename = chk1_2ydimodel_2phkmuta_LLRLCTW_atms_top_0001.contacts (canoncila name)
        df = pd.read_table(filename,sep = '\t', names = ['Atom1', 'Atom2','Clash','Covalent','VdW_Clash','VdW','Proximal','Hydrogenbond',
                        'Weak_Hydrogen_Bond','Halogen_Bond','Ionic','Metal_Complex','Aromatic','Hydrophobic',
...
def make_calculation(fulltable):
    unipeptide = set(fulltable['peptide_name'])
     #get the dataframe
    columns = ['peptide_model','peptide_name','Clash','Covalent','VdW_Clash','VdW','Proximal','Hydrogenbond',
                        'Weak_Hydrogen_Bond','Halogen_Bond','Ionic','Metal_Complex','Aromatic','Hydrophobic',
    ...
    peptide_feature_contacts[['Clash','Covalent','VdW_Clash','VdW','Proximal','Hydrogenbond',
                        'Weak_Hydrogen_Bond','Halogen_Bond','Ionic','Metal_Complex','Aromatic','Hydrophobic',
                        'Carbonyl','Polar','Weak_Polar']] = peptide_feature_contacts[['Clash','Covalent','VdW_Clash','VdW','Proximal','Hydrogenbond',
                        'Weak_Hydrogen_Bond','Halogen_Bond','Ionic','Metal_Complex','Aromatic','Hydrophobic',
